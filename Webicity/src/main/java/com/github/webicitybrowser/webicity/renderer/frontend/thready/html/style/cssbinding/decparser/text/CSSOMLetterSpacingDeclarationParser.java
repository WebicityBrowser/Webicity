...
public class CSSOMLetterSpacingDeclarationParser implements CSSOMNamedDeclarationParser<CSSValue> {

	private final PropertyValueParser<CSSValue> letterSpacingParser = new LetterSpacingValueParser();
