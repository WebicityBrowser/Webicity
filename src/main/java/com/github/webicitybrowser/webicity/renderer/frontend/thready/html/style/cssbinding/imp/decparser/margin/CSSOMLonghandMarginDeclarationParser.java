...
public class CSSOMLonghandMarginDeclarationParser implements CSSOMNamedDeclarationParser<CSSValue> {
	...
	public CSSOMLonghandMarginDeclarationParser(Function<SizeCalculation, ? extends Directive> directiveFactory) {
