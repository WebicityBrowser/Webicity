...
import everyos.browser.spec.javadom.intf.EventInit;
import everyos.browser.spec.javadom.intf.EventTarget;
import everyos.browser.spec.javadom.intf.Node;
import everyos.browser.spec.javadom.intf.PathStruct;
import everyos.browser.spec.javadom.intf.ShadowRoot;
import everyos.browser.spec.javadom.intf.Slot;
import everyos.browser.spec.javadom.intf.Slottable;
import everyos.browser.spec.javadom.intf.html.DOMWindowPart;
import everyos.browser.spec.javadom.intf.html.PartialWindow;
import everyos.browser.spec.juievents.intf.MouseEvent;
