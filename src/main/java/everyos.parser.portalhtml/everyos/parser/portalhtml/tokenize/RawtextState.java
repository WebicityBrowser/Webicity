...
public class RawtextState implements TokenizeState {
	...
	private final RawtextLessThanSignState rawtextLessThanState;

	public RawtextState(HTMLParserContext context, Consumer<TokenizeState> callback) {
		callback.accept(this);
		this.context = context;
		this.rawtextLessThanState = context.getTokenizeState(RawtextLessThanSignState.class);
	}
