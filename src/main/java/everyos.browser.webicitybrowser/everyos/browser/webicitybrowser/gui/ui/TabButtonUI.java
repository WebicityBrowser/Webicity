...
import com.github.webicity.lace.basics.pipeline.paint.canvas.shapes.TextShape;
import com.github.webicity.lace.basics.pipeline.paint.paint.BasicPaint;
import com.github.webicity.lace.core.backend.ResourceAllocator;
...
class TabButtonContent extends SimpleComponentContent {
	...
	private void paintXButton(Canvas canvas, Size size) {
		LacePaint paint = new BasicPaint()
